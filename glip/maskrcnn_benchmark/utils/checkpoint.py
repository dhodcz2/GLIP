...
from glip.maskrcnn_benchmark.utils.model_serialization import load_state_dict
from glip.maskrcnn_benchmark.utils.c2_model_loading import load_c2_format
from glip.maskrcnn_benchmark.utils.big_model_loading import load_big_format
from glip.maskrcnn_benchmark.utils.pretrain_model_loading import load_pretrain_format
from glip.maskrcnn_benchmark.utils.imports import import_file
from glip.maskrcnn_benchmark.utils.model_zoo import cache_url
    ...
    def _load_file(self, f):
        ...
        if f.startswith("catalog://"):
            paths_catalog = import_file(
                "glip.maskrcnn_benchmark.config.paths_catalog", self.cfg.PATHS_CATALOG, True
            )
