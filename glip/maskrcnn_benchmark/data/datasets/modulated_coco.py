...
from glip.maskrcnn_benchmark.structures.segmentation_mask import SegmentationMask
from glip.maskrcnn_benchmark.data.datasets.coco import has_valid_annotation
