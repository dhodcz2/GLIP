...
from glip.maskrcnn_benchmark.layers import smooth_l1_loss
...
from glip.maskrcnn_benchmark.layers import SigmoidFocalLoss, IOULoss, TokenSigmoidFocalLoss
from glip.maskrcnn_benchmark.utils.comm import get_world_size, reduce_sum
from glip.maskrcnn_benchmark.utils.amp import custom_fwd, custom_bwd
from glip.maskrcnn_benchmark.utils.shallow_contrastive_loss_helper import *
...
class FCOSLossComputation(object):
    ...
    def get_sample_region(self, gt, strides, num_points_per, gt_xs, gt_ys, radius=1.0):
        ...
        glip.maskrcnn_benchmark/modeling/rpn/fcos/loss.py#L42
        '''
        num_gts = gt.shape[0]
        K = len(gt_xs)
        ...
        if positive_map is not None and proj_tokens is not None:
            ...
            if shallow_img_emb_feats is not None:
                ...
                if self.cfg.MODEL.DYHEAD.FUSE_CONFIG.USE_BACKBONE_SHALLOW_CONTRASTIVE_LOSS:
                    ...
                    from glip.maskrcnn_benchmark.layers.roi_align import ROIAlignV2
