...
from glip.maskrcnn_benchmark.engine.inference import _accumulate_predictions_from_multiple_gpus
from glip.maskrcnn_benchmark.modeling.backbone.nas import get_layer_name
from glip.maskrcnn_benchmark.utils.comm import synchronize, get_rank, is_main_process, get_world_size, all_gather
from glip.maskrcnn_benchmark.data.datasets.evaluation import evaluate
from glip.maskrcnn_benchmark.utils.flops import profile
...
class EvolutionTrainer(object):
    ...
    def train(self, train_loader, val_loader):
        logger = logging.getLogger("glip.maskrcnn_benchmark.evolution")
