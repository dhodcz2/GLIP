...
from glip.maskrcnn_benchmark.utils.comm import get_world_size, all_gather, is_main_process, broadcast_data, get_rank
from glip.maskrcnn_benchmark.utils.metric_logger import MetricLogger
from glip.maskrcnn_benchmark.utils.ema import ModelEma
...
def do_train(
    ...
    logger = logging.getLogger("glip.maskrcnn_benchmark.trainer")
