...
from glip.maskrcnn_benchmark.utils.env import setup_environment  # noqa F401 isort:skip
...
import pdb
import torch
from glip.maskrcnn_benchmark.config import cfg, try_to_find
from glip.maskrcnn_benchmark.data import make_data_loader
from glip.maskrcnn_benchmark.solver import make_lr_scheduler
from glip.maskrcnn_benchmark.solver import make_optimizer
from glip.maskrcnn_benchmark.engine.inference import inference
from glip.maskrcnn_benchmark.engine.trainer import do_train
from glip.maskrcnn_benchmark.engine.alter_trainer import do_train as alternative_train
from glip.maskrcnn_benchmark.engine.stage_trainer import do_train as multi_stage_train
from glip.maskrcnn_benchmark.modeling.detector import build_detection_model
from glip.maskrcnn_benchmark.utils.checkpoint import DetectronCheckpointer
from glip.maskrcnn_benchmark.utils.collect_env import collect_env_info
from glip.maskrcnn_benchmark.utils.comm import synchronize, get_rank, is_main_process
from glip.maskrcnn_benchmark.utils.imports import import_file
from glip.maskrcnn_benchmark.utils.logger import setup_logger
from glip.maskrcnn_benchmark.utils.miscellaneous import mkdir, save_config
from glip.maskrcnn_benchmark.utils.metric_logger import (MetricLogger, TensorboardLogger)
import shutil
...
def main():
    ...
    if output_dir:
        mkdir(output_dir)
    logger = setup_logger("glip.maskrcnn_benchmark", output_dir, get_rank())
