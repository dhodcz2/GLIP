...
from glip.maskrcnn_benchmark.utils.comm import get_rank, is_main_process
...
from glip.tools.test_net import run_test
...
def main():
    ...
    logger = setup_logger("glip.maskrcnn_benchmark", cfg.OUTPUT_DIR, get_rank())
    logger.info(args)
