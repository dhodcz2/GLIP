...
from glip.maskrcnn_benchmark.utils.miscellaneous import mkdir
from glip.maskrcnn_benchmark.utils.stats import get_model_complexity_info
from glip.maskrcnn_benchmark.engine.predictor_glip import GLIPDemo
import matplotlib.pyplot as plt
import matplotlib.pylab as pylab
...
def main():
    ...
    logger = setup_logger("glip.maskrcnn_benchmark", log_dir, get_rank())
    logger.info(args)
